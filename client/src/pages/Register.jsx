...
const Register = () => {
  ...
  return (
    <div className="pt-32 pb-20 min-h-screen flex items-center justify-center px-6 relative">
      {/* Video Background */}
      ...
      >
        <div className="glass-card border-none shadow-2xl flex flex-col lg:flex-row min-h-[700px] overflow-visible">
          {/* Left Column: Branding/Type Selection */}
          <div className="lg:w-[22%] p-10 lg:p-12 bg-primary/10 border-r border-white/5 flex flex-col justify-between rounded-t-2xl lg:rounded-l-2xl lg:rounded-tr-none overflow-hidden relative">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-4xl font-black uppercase italic tracking-tighter leading-tight mb-4">
                Forge <br /> <span className="text-primary">Community</span>
              </h1>
              <p className="text-gray-400 text-[11px] font-black uppercase tracking-[0.2em] leading-relaxed mb-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className={`w-full p-5 rounded-xl border transition-all text-left group ${formType === 'membership' ? 'bg-primary border-primary shadow-[0_0_30px_rgba(225,6,0,0.3)]' : 'bg-white/5 border-white/10 hover:border-primary/50'}`}
              >
                <p className={`text-[10px] font-black uppercase tracking-widest ${formType === 'membership' ? 'text-white/80' : 'text-gray-500'}`}>Premium Tier</p>
                <p className="font-black italic text-base mt-1">Community Member</p>
                <div className="flex justify-between items-center mt-2">
                   <span className="text-[11px] font-bold opacity-60">₹4,999 / Year</span>
              ...
              <button
                ...
                className={`w-full p-5 rounded-xl border transition-all text-left group ${formType === 'basic' ? 'bg-primary border-primary shadow-[0_0_30px_rgba(225,6,0,0.3)]' : 'bg-white/5 border-white/10 hover:border-primary/50'}`}
              >
                <p className={`text-[10px] font-black uppercase tracking-widest ${formType === 'basic' ? 'text-white/80' : 'text-gray-500'}`}>Standard Access</p>
                <p className="font-black italic text-base mt-1">Free Account</p>
                <div className="flex justify-between items-center mt-2">
                   <span className="text-[11px] font-bold opacity-60">Basic Website Access</span>
          ...
          <div className="flex-1 p-10 lg:p-14">
            <div className="mb-12">
              ...
              <p className="text-gray-500 text-[11px] font-black uppercase tracking-[0.4em]">Biometric & Legal Verification</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="group">
                  <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Athlete Name</label>
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      required
                      className="input-hero pl-12 py-5"
                ...
                <div className="group">
                  <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Digital Identity</label>
                  <div className="relative">
              ...
              {formType === 'membership' && (
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="group">
                      <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Communication</label>
                      <div className="relative flex items-center bg-black border border-white/10 rounded-xl focus-within:border-primary/40 focus-within:ring-1 focus-within:ring-primary/10 transition-all group h-[68px]">
                        ...
                        <div className="relative h-full flex items-center border-r border-white/10">
                          <select
                            className="h-full w-32 bg-transparent pl-12 pr-8 text-[11px] font-black outline-none appearance-none cursor-pointer uppercase text-white"
                        ...
                        <input
                          type="tel"
                          required
                          className="flex-1 h-full bg-transparent px-6 text-[13px] font-bold tracking-widest outline-none text-white placeholder:text-gray-700 uppercase"
                    ...
                    <div className="group">
                      <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Nationality</label>
                      <div className="relative">
                        ...
                        <select
                          className="input-hero pl-12 pr-10 appearance-none cursor-pointer py-5"
                  ...
                  <div className="group">
                    <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Permanent Address</label>
                    <div className="relative">
                      <MapPin className="absolute left-4 top-6 text-gray-600 group-focus-within:text-primary transition-colors" size={18} />
                      <textarea
                        className="input-hero pl-12 min-h-[120px] py-5 leading-relaxed"
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="group">
                      <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Citizenship Proof</label>
                      <div className="relative">
                    ...
                    {formData.nationality === 'Indian' && (
                      <div className="group">
                        <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Aadhaar Verification</label>
                        <div className="relative">
              ...
              <div className="group">
                <label className="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-3 ml-1">Security Key</label>
                <div className="relative">
              ...
              <button type="submit" className="hero-button w-full py-6 text-base group mt-4">

...
const Login = () => {
  ...
  return (
    <div className="pt-24 pb-12 min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      {/* Video Background */}
      ...
      >
        <div className="glass-card overflow-hidden border-none shadow-2xl flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-10 md:p-14 border-r border-white/5">
            <div className="mb-10">
              <h1 className="text-3xl font-black uppercase italic tracking-tighter mb-2">
                Athlete <span className="text-primary">Login</span>
              </h1>
              <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.4em]">Credentials Access</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="group">
                ...
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-primary" size={18} />
                  <input
                    type="email"
              ...
              <div className="group">
                ...
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-600 group-focus-within:text-primary" size={18} />
                  <input
                    type="password"
                    className="input-hero pl-12 py-4"
                    placeholder="••••••••"
              ...
              <button type="submit" className="hero-button w-full py-4 text-sm group">
          ...
          <div className="flex-1 p-10 md:p-14 bg-black/40 backdrop-blur-sm flex flex-col justify-center">
